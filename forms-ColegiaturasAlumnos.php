...
<head>
  ...
  <title>Colegiaturas Alumnos</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>  
            <a href="forms-GestionarUsuarios.php">
              <i class="bi bi-circle"></i><span>Gestionar Usuario</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
          ...
          <ul id="alumnos-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
              <li class="nav-item">
                  ...
                  <ul id="ingenieria-nav" class="nav-content collapse">
                      ...
                      <li>
                          <a href="forms-ColegiaturasAlumnos.php" class="active">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="ri-team-line"></i><span>Maestros</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
              ...
              <i class="bi bi-circle"></i><span>Gestion de Mestros</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="ri-team-line"></i><span>Coordinacion</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-general.html">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="ri-team-line"></i><span>Vicerrectoria</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-general.html">
  ...
  <main id="main" class="main">
      ...
      <div class="pagetitle">
        <h1>Colegiaturas</h1>              <!-- =========================================================titulo page ================================================ -->
      <nav>
        <ol class="breadcrumb">
